...
- [x] 5. Meta-test: run `./ralph-loop.sh plan` — plan mode should detect this plan is complete, offer to archive it, and archive to `archive/2026-03-10_archive-support/` — **HUMAN CHECKPOINT**
