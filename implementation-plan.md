...
- [ ] 1. Create `specs/evaluation-metrics.md` — define each metric (cost, productivity, quality gates, context efficiency, task completion), how it's collected, what "good" looks like — **coder**
