...
- [ ] 6. Audit `ralph-loop.sh` for any remaining hardcoded paths that assume ralPhD is the project root (vs. RALPH_HOME pointing to the framework while CWD is the project) — **coder**
