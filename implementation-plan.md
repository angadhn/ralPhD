...
- [x] 2. Consolidate plan mode into early-exit block at top of loop (depends: 1) — **refactorer**
...
- [x] 3. Extract model/effort resolution into helper function (depends: 1) — **refactorer**
